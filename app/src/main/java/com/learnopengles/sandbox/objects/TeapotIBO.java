...
public class TeapotIBO {
    ...
    public TeapotIBO(float[] color) {

        final float[] vertexData = new float[2781 * STRIDE_IN_FLOATS];
        int i;
        /*
         ...
         */
        int positionDataLength = teapotPositionData.length;
        int normalDataLength = teapotNormalData.length;
        int offset = 0;
        int data_index = 0;
        for (i = 0; i < positionDataLength/3; i++) {
        ...
        for (i = 0; i < teapot_indices.length; i++) {
            if (teapot_indices[i] == -1) {
                num_degenerates++;
            }
        }
        final short[] indexData = new short[teapot_indices.length + num_degenerates];
        /*
    ...
    float teapotPositionData[] /* teapot_vertices[] */ = { 0.0663056f, 0.117825f, 2.10688e-008f,
            ...
            2.18868e-008f };
    static float teapotNormalData[] /* teapot_normals[] */ = { -0.987635f, -0.156768f, 0f, -0.902861f,
    ...
    static short  teapot_indices[] =
            { 1122, 1243, 1272, 1242, 1273, 1241, 1274,
