...
public class GLSurfaceViewDisplayScaled extends GLSurfaceView
{
	...
	public GLSurfaceViewDisplayScaled(Context context)
	{
		super(context);
	}

	public GLSurfaceViewDisplayScaled(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}
...
//                        Timber.i("pinchzoom deltaSpacing = " + deltaSpacing);
	...
	public void setRenderer(RendererDisplayScaled renderer, float density)
	{
		mRenderer = renderer;
		mDensity = density;
